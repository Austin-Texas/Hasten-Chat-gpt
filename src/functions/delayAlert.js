...
Deno.serve(async (req) => {
  try {
    ...
    for (const load of inTransitLoads) {
      // Skip if no ETA or already delivered
    ...
    // Alert dispatch team about critical delays (>30 minutes)
